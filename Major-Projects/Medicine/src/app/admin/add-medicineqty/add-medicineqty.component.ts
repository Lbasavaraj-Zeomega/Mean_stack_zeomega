...
@Component({
  selector: 'app-add-medicineqty',
  templateUrl: './add-medicineqty.component.html',
  styleUrls: ['./add-medicineqty.component.css']
})
export class AddMedicineqtyComponent implements OnInit {
